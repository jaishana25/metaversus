    ...
    className={`${styles.innerWidth} mx-auto ${styles.flexCenter} flex-col`}>
      ...
      className='mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white'>
        ...
        where you can enjoy the virtual world by feeling like it's really real,
         ...
         because this is really the  <span className='font-extrabold text-white'>madness</span>  of the metaverse of today,using only  <span className='font-extrabold text-white'>VR</span>  devices you can easily  <span className='font-extrabold text-white'>explore</span> the metaverse world you want, turn your dreams into reality. Let's explore the madness of the metaverse by scrolling down
