...
const World = () => (
  ...
  >
    ...
    className='relative mt-[68px] flex w-full h0[550px]'>
      ...
      <div className='absolute top-[48%] left-[24%] w-[100px] h-[70px] p-[6px] '>
        <img
        src="card01.png" alt="card"
        className='w-full h-full'/>
      </div>
      <div className='absolute top-10 right-20 w-[100px] h-[70px] p-[6px] '>
        <img
        src="card02.png" alt="card"
        className='w-full h-full'/>
      </div>
    </motion.div>
    </motion.div>
